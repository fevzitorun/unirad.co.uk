...
function unirad_seo_create_pages() {
    ...
    foreach ( unirad_seo_locations() as $slug => $loc ) {
        ...
        $yoast_desc  = 'Private MRI scan for ' . $loc['name'] . ' patients from £290. Same-week appointments, no GP referral needed. Expert radiologist report in 5 days. Just ' . $loc['mins'] . ' minutes from ' . $loc['name'] . '.';
    ...
    $schema = wp_json_encode( [
        ...
        '@graph'   => [
            ...
            [
                '@type'      => 'FAQPage',
                'mainEntity' => [
                    [ '@type' => 'Question', 'name' => 'Do I need a GP referral for an MRI scan?', 'acceptedAnswer' => [ '@type' => 'Answer', 'text' => 'No. At Unirad you can self-refer — book directly online without a GP referral.' ] ],
...
<section class="un-hero">
  <div class="un-hero-inner">
    ...
    <p class="un-hero-sub"><?php echo esc_html( $blurb ); ?> Book your scan for this week — no GP referral needed and your radiologist report is ready in 5 working days.</p>
    <div class="un-hero-pills">
      <span class="un-pill"><b>£290</b> from</span>
      <span class="un-pill">&#9733; 5-star rated</span>
      <span class="un-pill">&#10003; No referral needed</span>
...
<div class="un-section">
  ...
  <div class="un-benefits" style="margin-bottom:40px;">
    ...
    <div class="un-benefit">
      <div class="un-benefit-icon">&#128203;</div>
      <div class="un-benefit-text"><b>No referral needed</b><span>Self-refer and book directly — no GP letter required</span></div>
    </div>
    <div class="un-benefit">
      <div class="un-benefit-icon">&#128663;</div>
  ...
  <div class="un-faq">
    <div class="un-faq-item">
      <div class="un-faq-q">Do I need a GP referral to book an MRI scan?</div>
      <div class="un-faq-a">No. At Unirad you can self-refer — simply book online without needing a GP letter or referral. This is one of the main reasons patients from <?php echo esc_html( $name ); ?> choose private MRI.</div>
    </div>
    <div class="un-faq-item">
...
<div class="un-cta-banner">
  ...
  <p class="un-cta-sub">No referral needed &middot; Radiologist report included &middot; Free parking</p>
</div>
